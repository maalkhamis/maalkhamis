...
data <- read.csv("CoastBleeding.csv", row.names=1)
head(data)
...
shapley <- Shapley$new(mod, x.interest = X[2306,]);shapley$plot()+ theme_bw()
...
Y[2613] #see if observation was negative postive
#negative = 2307
